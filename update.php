            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <form class="d-flex" role="search">
                        <a class="btn btn-outline-warning me-3" aria-current="page" href="index.php">Back</a>
  ...
  ================================================== -->
        ...
        <div class="container marketing">
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-lg-4">
                        <img src="images/<?= $data['gambar'] ?>" class="rounded" width="140" height="140" alt="">
                        <h2 class="fw-normal mt-3"><?= $data['nama'] ?></h2>
                        <p><?= $data['deskripsi'] ?></p>
                        <p><a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#beli<?php echo $data["id"]; ?>">Update Data &raquo;</a></p>
                    </div>
                    <!-- modal dari sini -->
                    <div class=" modal fade" id="beli<?php echo $data["id"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="updateaksi.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input name="deskripsi" value="<?= $data['deskripsi'] ?>">
                                    </div>
                                    <div class="modal-body">
                                        <label>Gambar Produk</label>
                                        <input name="gambar" class="form-control" type="file">
                                        <img width="130" class="mt-3" src="images/<?= $data['gambar'] ?>" alt="" width="600px">
                ...
                <div class="row featurette">
                    ...
                    <div class="col-md-5">
                        <img src="assets/beton.jpeg" width="100%" height="100%" alt="">
                ...
                <div class="row featurette">
                    ...
                    <div class="col-md-5 order-md-1">
                        <img src="assets/beton1.jpeg" width="100%" height="100%" alt="">
                ...
                <div class="row featurette">
                    ...
                    <div class="col-md-5">
                        <img src="assets/beton2.jpeg" width="100%" height="100%" alt="">
